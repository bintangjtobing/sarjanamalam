...
! function (t, e) {
    ...
    var i = function () {
        ...
        p = function () {
            function t(e, t) {
                if (this.$node = e, this.options = $.extend({}, {
                        title: "",
                        target: t.container,
                        trigger: "hover focus",
                        placement: "bottom"
                    }, t), this.$tooltip = $(['<div class="note-tooltip in">', '  <div class="note-tooltip-arrow"/>', '  <div class="note-tooltip-content"/>', "</div>"].join("")), "manual" !== this.options.trigger) {
                    var o = this.show.bind(this),
                        n = this.hide.bind(this),
                        i = this.toggle.bind(this);
                    this.options.trigger.split(" ").forEach(function (t) {
                        "hover" === t ? (e.off("mouseenter mouseleave"), e.on("mouseenter", o).on("mouseleave", n)) : "click" === t ? e.on("click", i) : "focus" === t && e.on("focus", o).on("blur", n)
                    })
                }
            }
            return t.prototype.show = function () {
                ...
                o.addClass(i), o.addClass("in"), o.find(".note-tooltip-content").text(n), o.appendTo(this.options.target);
                var r = t.outerWidth(),
                    s = t.outerHeight(),
                    a = o.outerWidth(),
                    l = o.outerHeight();
        ...
        o = function () {
            function t(t, e) {
                this.$button = t, this.options = $.extend({}, {
                    target: e.container
                }, e), this.setEvent()
            }
            return t.prototype.setEvent = function () {
                var e = this;
    ...
    $(document).on("click", function (t) {
        $(t.target).closest(".note-btn-group").length || $(".note-btn-group.open").removeClass("open")
    ...
    var n = function () {
            function t(t, e) {
                ...
                }, e), this.$modal = t, this.$backdrop = $('<div class="note-modal-backdrop" />')
            }
            return t.prototype.show = function () {
                "body" === this.options.target ? (this.$backdrop.css("position", "fixed"), this.$modal.css("position", "fixed")) : (this.$backdrop.css("position", "absolute"), this.$modal.css("position", "absolute")), this.$backdrop.appendTo(this.options.target).show(), this.$modal.appendTo(this.options.target).addClass("open").show(), this.$modal.trigger("note.modal.show"), this.$modal.off("click", ".close").on("click", ".close", this.hide.bind(this))
            }, t.prototype.hide = function () {
                this.$modal.removeClass("open").hide(), this.$backdrop.hide(), this.$modal.trigger("note.modal.hide")
            }, t
        }(),
        e = t('<div class="note-editor note-frame"/>'),
        r = t('<div class="note-toolbar" role="toolbar"/>'),
        s = t('<div class="note-editing-area"/>'),
        a = t('<textarea class="note-codable" role="textbox" aria-multiline="true"/>'),
        l = t('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>'),
        c = t(['<output class="note-status-output" role="status" aria-live="polite"/>', '<div class="note-statusbar" role="resize">', '  <div class="note-resizebar" role="seperator" aria-orientation="horizontal" aria-label="resize">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', "  </div>", "</div>"].join("")),
        d = t('<div class="note-editor"/>'),
        u = t(['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>', '<output class="note-status-output" role="status" aria-live="polite"/>'].join("")),
        h = t('<div class="note-btn-group">'),
        f = t('<button type="button" class="note-btn" role="button" tabindex="-1">', function (t, e) {
            e && e.tooltip && (t.attr({
                "aria-label": e.tooltip
            }), t.data("_lite_tooltip", new p(t, {
                title: e.tooltip,
                container: e.container
            })).on("click", function (t) {
                $(t.currentTarget).data("_lite_tooltip").hide()
            })), e.contents && t.html(e.contents), e && e.data && "dropdown" === e.data.toggle && t.data("_lite_dropdown", new o(t, {
                container: e.container
            }))
        }),
        m = t('<div class="note-dropdown-menu" role="list">', function (t, i) {
            var e = Array.isArray(i.items) ? i.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "",
                    ...
                    n = $('<a class="note-dropdown-item" href="#" data-value="' + e + '" role="listitem" aria-label="' + e + '"></a>');
        ...
        g = t('<div class="note-dropdown-menu note-check" role="list">', function (t, i) {
            var e = Array.isArray(i.items) ? i.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "",
                    o = i.template ? i.template(t) : t,
                    n = $('<a class="note-dropdown-item" href="#" data-value="' + e + '" role="listitem" aria-label="' + t + '"></a>');
        ...
        v = t('<div class="note-color-palette"/>', function (t, e) {
            for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
                for (var r = e.eventName, s = e.colors[n], a = e.colorsName[n], l = [], c = 0, d = s.length; c < d; c++) {
                    var u = s[c],
                        h = a[c];
                    l.push(['<button type="button" class="note-btn note-color-btn"', 'style="background-color:', u, '" ', 'data-event="', r, '" ', 'data-value="', u, '" ', 'title="', h, '" ', 'aria-label="', h, '" ', 'data-toggle="button" tabindex="-1"></button>'].join(""))
                }
                o.push('<div class="note-color-row">' + l.join("") + "</div>")
            }
            t.html(o.join("")), t.find(".note-color-btn").each(function () {
                $(this).data("_lite_tooltip", new p($(this), {
                    container: e.container
                }))
            })
        }),
        b = t('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function (t, e) {
        ...
        y = t(['<div class="note-popover bottom">', '  <div class="note-popover-arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""), function (t, e) {
        ...
        x = {
                ...
                return h([f({
                    ...
                    callback: function (t) {
                        t.find(".note-dimension-picker-mousecatcher").css({
                            width: e.col + "em",
                            height: e.row + "em"
                        }).mousedown(e.itemClick).mousemove(function (t) {
                            ! function (t, e, o) {
                                var n, i = $(t.target.parentNode),
                                    r = i.next(),
                                ...
                                a.css({
                                    width: d + "em",
                                    height: u + "em"
                                }), s.data("value", d + "x" + u), 3 < d && d < e && l.css({
                                    width: d + 1 + "em"
                                }), 3 < u && u < o && l.css({
                                    height: u + 1 + "em"
                                }), r.html(d + " x " + u)
                ...
                return h({
                    ...
                    children: [f({
                        ...
                        callback: function (t) {
                            ...
                            "foreColor" !== d && (e.css("background-color", "#fffF00"), t.attr("data-backColor", "#fffF00"))
                        }
                    }), f({
                        className: "dropdown-toggle",
                        ...
                        callback: function (t) {
                            ...
                            }), "fore" === d ? (t.find(".btn-background-color").hide(), t.css({
                                "min-width": "210px"
                            })) : "back" === d && (t.find(".btn-foreground-color").hide(), t.css({
                                "min-width": "210px"
                            }))
                        },
                        click: function (t) {
                            ...
                            if ("cp" === n ? t.stopPropagation() : "cpbackColor" === n ? n = r : "cpforeColor" === n && (n = i), o && n) {
                                var s = "backColor" === o ? "background-color" : "color",
                                    a = e.closest(".note-color").find(".note-recent-color"),
                                    l = e.closest(".note-color").find(".note-current-color-button");
                                a.css(s, n), l.attr("data-" + o, n), "fore" === d ? c.itemClick("foreColor", n) : "back" === d ? c.itemClick("backColor", n) : c.itemClick(o, n)
                            }
                        }
                    })]
                }).render()
            ...
            videoDialog: function (t) {
                var e = '<div class="note-form-group"><label class="note-form-label">' + t.lang.video.url + ' <small class="text-muted">' + t.lang.video.providers + '</small></label><input class="note-video-url note-input" type="text" /></div>',
            ...
            createLayout: function (t, e) {
                var o = (e.airMode ? x.airEditor([x.editingArea([x.airEditable()])]) : x.editor([x.toolbar(), x.editingArea([x.codable(), x.editable()]), x.statusbar()])).render();
    ...
    var R = /Edge\/\d+/.test(T),
        L = !!window.CodeMirror,
        A = "ontouchstart" in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints,
        F = N || R ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input",
        P = {
    ...
    var U = {
            ...
            sum: function (t, o) {
                return o = o || D.self, t.reduce(function (t, e) {
                    return t + o(e)
                }, 0)
            },
            from: function (t) {
            ...
            clusterBy: function (t, n) {
                return t.length ? M(t).reduce(function (t, e) {
                    var o = z(t);
            ...
            unique: function (t) {
                for (var e = [], o = 0, n = t.length; o < n; o++) O(e, t[o]) || e.push(t[o]);
                return e
            }
        },
    ...
    function lt(t) {
        var e = at(t);
        return 0 === e || (!V(t) && 1 === e && t.innerHTML === st || !(!U.all(t.childNodes, V) || "" !== t.innerHTML))
    }
    ...
    function $t(t, e) {
        ...
        return ft(s, ht(r)), o || (ct(t.node), ct(s)), i && (lt(t.node) && Nt(t.node), lt(s)) ? (Nt(s), t.node.nextSibling) : s
    }

    function It(t, o, n) {
        var e = ut(o.node, D.eq(t));
        return e.length ? 1 === e.length ? $t(o, n) : e.reduce(function (t, e) {
            return t === o.node && (t = $t(o, n)), $t({
                node: e,
                offset: t ? kt(t) : at(e)
            }, n)
        }) : null
    ...
    var Lt = {
            ...
            walkPoint: function (t, e, o, n) {
                for (var i = t; i && (o(i), !St(i, e));) i = xt(i, n && t.node !== i.node && e.node !== i.node)
            },
            ancestor: dt,
            ...
            replace: function (t, e) {
                ...
                var o = Tt(e);
                return t.style.cssText && (o.style.cssText = t.style.cssText), ft(o, U.from(t.childNodes)), pt(o, t), Nt(t), o
            },
            html: function (t, e) {
                var o = Rt(t);
        ...
        At = function () {
            ...
            return t.prototype.initialize = function () {
                ...
                this.code(Lt.emptyPara), this._destroy(), this._initialize(), t && this.disable()
                ...
                e.shouldInitialize = e.shouldInitialize || D.ok, e.shouldInitialize() && (e.initialize && e.initialize(), e.events && Lt.attachEvents(this.$note, e.events))
                ...
                var e = this.modules[t];
                e.shouldInitialize() && (e.events && Lt.detachEvents(this.$note, e.events), e.destroy && e.destroy()), delete this.modules[t]
    ...
    function Ft(t, e) {
        ...
        for (o = 0; o < s.length; o++)
            ...
            l.nodeValue;
            e && l.nextSibling && Lt.isText(l.nextSibling) && d === l.nodeValue.length && (d -= l.nodeValue.length, l = l.nextSibling), i = l, o = d
        }
        return {
            cont: i,
            offset: o
    ...
    function Pt(t) {
        var s = function (t, e) {
                ...
                if (Lt.isText(t)) {
                    ...
                    o = r || t.parentNode, e += U.sum(U.tail(i), Lt.nodeLength), n = !r
                } else {
    ...
    C.fn.extend({
        summernote: function () {
            ...
            i.langInfo = C.extend(!0, {}, C.summernote.lang["en-US"], C.summernote.lang[i.lang]), i.icons = C.extend(!0, {}, C.summernote.options.icons, i.icons), i.tooltip = "auto" === i.tooltip ? !P.isSupportTouch : i.tooltip, this.each(function (t, e) {
                var o = C(e);
    ...
    var Ht = function () {
            function r(t, e, o, n) {
                this.sc = t, this.so = e, this.ec = o, this.eo = n, this.isOnEditable = this.makeIsOn(Lt.isEditable), this.isOnList = this.makeIsOn(Lt.isList), this.isOnAnchor = this.makeIsOn(Lt.isAnchor), this.isOnCell = this.makeIsOn(Lt.isCell), this.isOnData = this.makeIsOn(Lt.isData)
            }
            return r.prototype.nativeRange = function () {
                ...
                var t = function (t, e) {
                        if (Lt.isVisiblePoint(t) && (!Lt.isEdgePoint(t) || Lt.isRightEdgePoint(t) && !e || Lt.isLeftEdgePoint(t) && e || Lt.isRightEdgePoint(t) && e && Lt.isVoid(t.node.nextSibling) || Lt.isLeftEdgePoint(t) && !e && Lt.isVoid(t.node.previousSibling) || Lt.isBlock(t.node) && Lt.isEmpty(t.node))) return t;
                        var o = Lt.ancestor(t.node, Lt.isBlock);
                        if ((Lt.isLeftEdgePointOf(t, o) || Lt.isVoid(Lt.prevPoint(t).node)) && !e || (Lt.isRightEdgePointOf(t, o) || Lt.isVoid(Lt.nextPoint(t).node)) && e) {
                            if (Lt.isVisiblePoint(t)) return t;
                            e = !e
                        }
                        return (e ? Lt.nextPointUntil(Lt.nextPoint(t), Lt.isVisiblePoint) : Lt.prevPointUntil(Lt.prevPoint(t), Lt.isVisiblePoint)) || t
                    },
                ...
                var n = t && t.includeAncestor,
                    ...
                    s = [],
                    a = [];
                return Lt.walkPoint(e, r, function (t) {
                    var e;
                    Lt.isEditable(t.node) || (i ? (Lt.isLeftEdgePoint(t) && a.push(t.node), Lt.isRightEdgePoint(t) && U.contains(a, t.node) && (e = t.node)) : e = n ? Lt.ancestor(t.node, o) : t.node, e && o(e) && s.push(e))
                }, !0), U.unique(s)
                ...
                return e && (n.sc = e, n.so = 0), o && (n.ec = o, n.eo = Lt.nodeLength(o)), new r(n.sc, n.so, n.ec, n.eo)
                ...
                var t = this.sc === this.ec,
                    e = this.getPoints();
                return Lt.isText(this.ec) && !Lt.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo), Lt.isText(this.sc) && !Lt.isEdgePoint(this.getStartPoint()) && (e.sc = this.sc.splitText(this.so), e.so = 0, t && (e.ec = e.sc, e.eo = this.eo - this.so)), new r(e.sc, e.so, e.ec, e.eo)
                ...
                return C.each(e, function (t, e) {
                    var o = e.parentNode;
                    n.node !== o && 1 === Lt.nodeLength(o) && i.push(o), Lt.remove(e, !1)
                ...
                if (Lt.isBodyContainer(this.sc) && Lt.isEmpty(this.sc)) return this.sc.innerHTML = Lt.emptyPara, new r(this.sc.firstChild, 0, this.sc.firstChild, 0);
                var t, e = this.normalize();
                if (Lt.isParaInline(this.sc) || Lt.isPara(this.sc)) return e;
                if (Lt.isInline(e.sc)) {
                    var o = Lt.listAncestor(e.sc, D.not(Lt.isInline));
                    t = U.last(o), Lt.isInline(t) || (t = o[o.length - 2] || e.sc.childNodes[e.so])
                } else t = e.sc.childNodes[0 < e.so ? e.so - 1 : 0];
                var n = Lt.listPrev(t, Lt.isParaInline).reverse();
                if ((n = n.concat(Lt.listNext(t.nextSibling, Lt.isParaInline))).length) {
                ...
                return t && (e = Lt.nextPointUntil(e, function (t) {
                    return !Lt.isCharPoint(t)
        ...
        Dt = {
            create: function (t, e, o, n) {
                ...
                return i || 1 !== arguments.length ? i : (i = this.createFromNode(t)).collapse(Lt.emptyPara === t.innerHTML)
            },
            createFromSelection: function () {
                ...
                if (P.isW3CRangeSupport) {
                    ...
                    var c = Ft(l, !0),
                        d = Ft(a, !1);
                    Lt.isText(c.node) && Lt.isLeftEdgePoint(c) && Lt.isTextNode(d.node) && Lt.isRightEdgePoint(d) && d.node.nextSibling === c.node && (c = d), t = c.cont, e = c.offset, o = d.cont, n = d.offset
                }
            ...
            createFromNode: function (t) {
                var e = t,
                    ...
                    n = t,
                    i = Lt.nodeLength(n);
                return Lt.isVoid(e) && (o = Lt.listPrev(e).length - 1, e = e.parentNode), Lt.isBR(n) ? (i = Lt.listPrev(n).length - 1, n = n.parentNode) : Lt.isVoid(n) && (i = Lt.listPrev(n).length, n = n.parentNode), this.create(e, o, n, i)
            },
        ...
        zt = {
            isEdit: function (t) {
                return U.contains([Bt.BACKSPACE, Bt.TAB, Bt.ENTER, Bt.SPACE, Bt.DELETE], t)
            },
            isMove: function (t) {
    ...
    var Mt = function () {
            ...
            return t.prototype.makeSnapshot = function () {
                ...
                null !== t.contents && this.$editable.html(t.contents), null !== t.bookmark && Dt.createFromBookmark(this.editable, t.bookmark).select()
        ...
        Ot = function () {
            ...
            return t.prototype.jQueryCSS = function (o, t) {
                ...
                return o.anchor = t.isOnAnchor() && Lt.ancestor(t.sc, Lt.isAnchor), o.ancestors = Lt.listAncestor(t.sc, Lt.isEditable), o.range = t, o
            }, t
        }(),
        Ut = function () {
            function t() {}
            return t.prototype.insertOrderedList = function (t) {
                ...
                C.each(i, function (t, e) {
                    var o = U.head(e);
                    Lt.isLi(o) ? n.releaseList([e]) : C.each(e, function (t, e) {
                        C(e).css("marginLeft", function (t, e) {
                ...
                }), Lt.appendChildNodes(s, t), r && (Lt.appendChildNodes(s, U.from(r.childNodes)), Lt.remove(r)), t
                ...
                return C.each(t, function (t, e) {
                    ...
                    if ("LI" === i.parentNode.nodeName) e.map(function (t) {
                        ...
                        var s = 1 < i.childNodes.length ? Lt.splitTree(i, {
                                node: n.parentNode,
                                offset: Lt.position(n) + 1
                            }, {
                        ...
                        e = c ? Lt.listDescendant(a, Lt.isLi) : U.from(a.childNodes).filter(Lt.isLi), !c && Lt.isList(i.parentNode) || (e = e.map(function (t) {
                ...
                return t.previousSibling ? Lt.appendChildNodes(t.previousSibling, [t]) : this.wrapList([t], "LI")
            }, t.prototype.findList = function (t) {
                return t ? U.find(t.children, function (t) {
        ...
        jt = function () {
            ...
            return t.prototype.insertTab = function (t, e) {
                ...
                (t = t.deleteContents()).insertNode(o, !0), (t = Dt.create(o, e)).select()
            }, t.prototype.insertParagraph = function (t, e) {
                e = (e = (e = e || Dt.create(t)).deleteContents()).wrapBodyInlineWithPara();
                var o, n = Lt.ancestor(e.sc, Lt.isPara);
                if (n) {
                    if (Lt.isEmpty(n) && Lt.isLi(n)) return void this.bullet.toggleList(n.parentNode.nodeName);
                    var i = null;
                    if (1 === this.options.blockquoteBreakingLevel ? i = Lt.ancestor(n, Lt.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (i = Lt.lastAncestor(n, Lt.isBlockquote)), i) {
                        o = C(Lt.emptyPara)[0], Lt.isRightEdgePoint(e.getStartPoint()) && Lt.isBR(e.sc.nextSibling) && C(e.sc.nextSibling).remove();
                        ...
                        s = s.concat(Lt.listDescendant(o, Lt.isEmptyAnchor)), C.each(s, function (t, e) {
                            Lt.remove(e)
                        }), (Lt.isHeading(o) || Lt.isPre(o) || Lt.isCustomStyleTag(o)) && Lt.isEmpty(o) && (o = Lt.replace(o, "p"))
                    }
                } else {
                    var a = e.sc.childNodes[e.so];
                    o = C(Lt.emptyPara)[0], a ? e.sc.insertBefore(o, a) : e.sc.appendChild(o)
                }
        ...
        Kt = function (t, h, p, i) {
            ...
            this.getActionList = function () {
                    for (var t, e, o, n = h === Kt.where.Row ? f.rowPos : -1, i = h === Kt.where.Column ? f.colPos : -1, r = 0, s = !0; s;) {
                        var a = 0 <= n ? n : r,
                            l = 0 <= i ? i : r,
                            c = m[a];
                        if (!c) return s = !1, g;
    ...
    var Wt, Vt = function () {
            ...
            return t.prototype.tab = function (t, e) {
                ...
                for (var o = Lt.ancestor(t.commonAncestor(), Lt.isCell), n = C(o).closest("tr"), i = this.recoverAttributes(n), r = C("<tr" + i + "></tr>"), s = new Kt(o, Kt.where.Row, Kt.requestAction.Add, C(n).closest("table")[0]).getActionList(), a = 0; a < s.length; a++) {
                    var l = s[a],
                        ...
                        case Kt.resultAction.SumSpanCount:
                            if ("top" === e)
                                if ((l.baseCell.parent ? l.baseCell.closest("tr").rowIndex : 0) <= n[0].rowIndex) {
                                    var d = C("<div></div>").append(C("<td" + c + ">" + Lt.blank + "</td>").removeAttr("rowspan")).html();
                                    r.append(d);
                                    break
                ...
                var o = Lt.ancestor(t.commonAncestor(), Lt.isCell),
                    n = C(o).closest("tr");
                C(n).siblings().push(n);
                for (var i = new Kt(o, Kt.where.Column, Kt.requestAction.Add, C(n).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) {
                    var s = i[r],
                        a = this.recoverAttributes(s.baseCell);
                    switch (s.action) {
                        case Kt.resultAction.AddCell:
                            "right" === e ? C(s.baseCell).after("<td" + a + ">" + Lt.blank + "</td>") : C(s.baseCell).before("<td" + a + ">" + Lt.blank + "</td>");
                            break;
                        case Kt.resultAction.SumSpanCount:
                            if ("right" === e) {
                                var l = parseInt(s.baseCell.colSpan, 10);
                                l++, s.baseCell.setAttribute("colSpan", l)
                            } else C(s.baseCell).before("<td" + a + ">" + Lt.blank + "</td>")
                    }
                }
                ...
                for (var e = Lt.ancestor(t.commonAncestor(), Lt.isCell), o = C(e).closest("tr"), n = o.children("td, th").index(C(e)), i = o[0].rowIndex, r = new Kt(e, Kt.where.Row, Kt.requestAction.Delete, C(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++)
                    if (r[s]) {
                        var a = r[s].baseCell,
                            l = r[s].virtualTable,
                ...
                for (var e = Lt.ancestor(t.commonAncestor(), Lt.isCell), o = C(e).closest("tr"), n = o.children("td, th").index(C(e)), i = new Kt(e, Kt.where.Column, Kt.requestAction.Delete, C(o).closest("table")[0]).getActionList(), r = 0; r < i.length; r++)
                ...
                for (var n, i = [], r = 0; r < t; r++) i.push("<td>" + Lt.blank + "</td>");
                n = i.join("");
        ...
        qt = function () {
            function t(t) {
                ...
                this.insertParagraph = this.wrapCommand(function () {
                    ...
                    u.isLimited(C(t).text().length) || (u.getLastRange().insertNode(t), Dt.createFromNodeAfter(t).select(), u.setLastRange())
                    ...
                    t.nextSibling && (Dt.create(t.nextSibling, 0).normalize().select(), u.setLastRange())
                    ...
                    if (!(0 < r && u.isLimited(r))) {
                        ...
                        Dt.create(c.node, c.offset, d.node, d.offset).select(), u.setLastRange()
                    }
            ...
            return t.prototype.initialize = function () {
                ...
                this.$editable.on("keydown", function (t) {
                    if (t.keyCode === zt.code.ENTER && e.context.triggerEvent("enter", t), e.context.triggerEvent("keydown", t), t.isDefaultPrevented() || (e.options.shortcuts ? e.handleKeyMap(t) : e.preventDefaultEditableShortCuts(t)), e.isLimited(1, t)) return !1
                }).on("keyup", function (t) {
                ...
                }), this.$editable.attr("spellcheck", this.options.spellCheck), this.$editable.html(Lt.html(this.$note) || Lt.emptyPara), this.$editable.on(P.inputEventName, D.debounce(function () {
                ...
                n && o.push(n);
                var i = e[o.join("+")];
                i ? !1 !== this.context.invoke(i) && t.preventDefault() : zt.isEdit(t.keyCode) && this.afterCommand()
                ...
                return t = t || 0, (void 0 === e || !(zt.isMove(e.keyCode) || e.ctrlKey || e.metaKey || U.contains([zt.code.BACKSPACE, zt.code.DELETE], e.keyCode))) && (0 < this.options.maxTextLength && this.$editable.text().length + t >= this.options.maxTextLength)
                ...
                return (o = t, C.Deferred(function (t) {
                    ...
                    n.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", Math.min(n.$editable.width(), t.width()))), t.show(), Dt.create(n.editable).insertNode(t[0]), Dt.createFromNodeAfter(t[0]).select(), n.setLastRange(), n.afterCommand()
                }).fail(function (t) {
                ...
                var t = this.getLastRange();
                return t.isOnAnchor() && (t = Dt.createFromNode(Lt.ancestor(t.sc, Lt.isAnchor))), t.toString()
            }, t.prototype.onFormatBlock = function (t, e) {
                if (document.execCommand("FormatBlock", !1, P.isMSIE ? "<" + t + ">" : t), e && e.length && (e[0].tagName.toUpperCase() !== t.toUpperCase() && (e = e.find(t)), e && e.length)) {
                    var o = e[0].className || "";
                    if (o) {
                ...
                if (o) {
                    ...
                    if (C(n).css(t, e), o.isCollapsed()) {
                        var i = U.head(n);
                        i && !Lt.nodeLength(i) && (i.innerHTML = Lt.ZERO_WIDTH_NBSP_CHAR, Dt.createFromNodeAfter(i.firstChild).select(), this.setLastRange(), this.$editable.data("bogus", i))
                    }
                }
                ...
                if (t.isOnAnchor()) {
                    ...
                    (t = Dt.createFromNode(e)).select(), this.setLastRange(), this.beforeCommand(), document.execCommand("unlink"), this.afterCommand()
                }
                ...
                return Lt.isEmpty(this.$editable[0]) || Lt.emptyPara === this.$editable.html()
    ...
    var Zt = function () {
            ...
            return t.prototype.sync = function () {
                this.isActivated() && P.hasCodeMirror && this.$codable.data("cmEditor").save()
                ...
                var e = this;
                if (this.$codable.val(Lt.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), P.hasCodeMirror) {
                ...
                var e = this.purify(Lt.value(this.$codable, this.options.prettifyHtml) || Lt.emptyPara),
        ...
        Jt = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i,
        te = function () {
            function t(t) {
                var o = this;
            ...
            return t.prototype.initialize = function () {
                ...
                U.contains([zt.code.ENTER, zt.code.SPACE], t.keyCode) && this.replace()
            }, t
        }(),
        ee = function () {
            function t(t) {
        ...
        oe = function () {
            function t(t) {
                var o = this;
                this.context = t, this.options = t.options.replace || {}, this.keys = [zt.code.ENTER, zt.code.SPACE, zt.code.PERIOD, zt.code.COMMA, zt.code.SEMICOLON, zt.code.SLASH], this.previousKeydownCode = null, this.events = {
                    "summernote.keyup": function (t, e) {
                        e.isDefaultPrevented() || o.handleKeyup(e)
                    },
                    "summernote.keydown": function (t, e) {
            ...
            return t.prototype.shouldInitialize = function () {
                ...
                if (this.lastWord) {
                    ...
                    this.options.match(t, function (t) {
                        if (t) {
                            var e = "";
                            if ("string" == typeof t ? e = Lt.createText(t) : t instanceof jQuery ? e = t[0] : t instanceof Node && (e = t), !e) return;
                            o.lastWord.insertNode(e), o.lastWord = null, o.context.invoke("editor.focus")
                        }
                    })
                }
            }, t.prototype.handleKeydown = function (t) {
                if (this.previousKeydownCode && U.contains(this.keys, this.previousKeydownCode)) this.previousKeydownCode = t.keyCode;
                else {
        ...
        ie = function () {
            function t(t) {
                this.ui = C.summernote.ui, this.context = t, this.$toolbar = t.layoutInfo.toolbar, this.options = t.options, this.lang = this.options.langInfo, this.invertedKeyMap = D.invertObject(this.options.keyMap[P.isMac ? "mac" : "pc"])
            }
            return t.prototype.representShortcut = function (t) {
                var e = this.invertedKeyMap[t];
                return this.options.shortcuts && e ? (P.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
                ...
                return this.fontInstalledMap.hasOwnProperty(t) || (this.fontInstalledMap[t] = P.isFontInstalled(t) || U.contains(this.options.fontNamesIgnoreCheck, t)), this.fontInstalledMap[t]
                ...
                this.context.memo("button.justifyLeft", D.invoke(r, "render")), this.context.memo("button.justifyCenter", D.invoke(s, "render")), this.context.memo("button.justifyRight", D.invoke(a, "render")), this.context.memo("button.justifyFull", D.invoke(l, "render")), this.context.memo("button.outdent", D.invoke(c, "render")), this.context.memo("button.indent", D.invoke(d, "render")), this.context.memo("button.paragraph", function () {
                    return n.ui.buttonGroup([n.button({
                        className: "dropdown-toggle",
        ...
        se = function () {
            ...
            return t.prototype.initialize = function () {
                ...
                t.on("keypress", function (t) {
                    t.keyCode === zt.code.ENTER && (t.preventDefault(), e.trigger("click"))
                })
                ...
                return C.Deferred(function (e) {
                    ...
                    a.ui.onDialogShown(a.$dialog, function () {
                        a.context.triggerEvent("dialog.shown"), !s.url && D.isValidUrl(s.text) && (s.url = s.text), o.on("input paste propertychange", function () {
                        ...
                        }).val(s.url), P.isSupportTouch || n.trigger("focus"), a.toggleLinkBtn(i, o, n), a.bindEnterKey(n, i), a.bindEnterKey(o, i);
            ...
            return t.prototype.initialize = function () {
                ...
                return C.Deferred(function (e) {
                    ...
                    i.ui.onDialogShown(i.$dialog, function () {
                        ...
                        }).val(""), P.isSupportTouch || o.trigger("focus"), n.click(function (t) {
        ...
        de = function () {
            ...
            return t.prototype.shouldInitialize = function () {
                ...
                var t = this.$popover.find(".popover-content,.note-popover-content");
                this.context.invoke("buttons.build", t, this.options.popover.table), P.isFF && document.execCommand("enableInlineTableEditing", !1, !1)
            }, t.prototype.destroy = function () {
                this.$popover.remove()
            ...
            return t.prototype.initialize = function () {
                ...
                return C.Deferred(function (e) {
                    ...
                    n.ui.onDialogShown(n.$dialog, function () {
                        ...
                        }), P.isSupportTouch || o.trigger("focus"), t.click(function (t) {
                            t.preventDefault(), e.resolve(o.val())
                        }), n.bindEnterKey(o, t)
            ...
            function t(t) {
                ...
                this.context = t, this.ui = C.summernote.ui, this.options = t.options, this.events = {
                    ...
                    "summernote.focusout": function (t, e) {
                        P.isFF || e.relatedTarget && Lt.ancestor(e.relatedTarget, D.eq(o.$popover[0])) || o.hide()
                    }
                }
            }
            return t.prototype.shouldInitialize = function () {
        ...
        fe = function () {
            ...
            return t.prototype.shouldInitialize = function () {
                ...
                if (t.length) {
                    ...
                    this.lastWordRange.insertNode(e), Dt.createFromNode(e).collapse().select(), this.lastWordRange = null, this.hide(), this.context.triggerEvent("change", this.$editable.html(), this.$editable[0]), this.context.invoke("editor.focus")
                }
                ...
                this.$popover.is(":visible") && (t.keyCode === zt.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === zt.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === zt.code.DOWN && (t.preventDefault(), this.moveDown()))
                ...
                var o = this;
                if (!U.contains([zt.code.ENTER, zt.code.UP, zt.code.DOWN], t.keyCode)) {
