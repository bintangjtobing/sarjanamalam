                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                        class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="{{$userMod->getAvatar()}}" alt="">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a class="btn-shadow d-inline-flex align-items-center btn
                                    btn-success" href="@yield('linkbtncreate')" role="button"><i
                                    class="fa fa-plus mr-2"></i> Create new @yield('btncreate')</a>
                        </div>
                    </div>
                </div>
                @yield('content')
