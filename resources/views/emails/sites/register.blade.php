...
Selamat {{$data_member->name}}, kamu telah berhasil menjadi keanggotaan di Sarjanamalam.<br>
...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #b8def5;">
	<!--[if IE]><div class="ie-browser"><![endif]-->
	<table bgcolor="#b8def5" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
		style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #b8def5; width: 100%;"
		valign="top" width="100%">
		<tbody>
			<tr style="vertical-align: top;" valign="top">
				<td style="word-break: break-word; vertical-align: top;" valign="top">
					<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color:#b8def5"><![endif]-->
					...
					<div style="background-color:transparent;">
						<div class="block-grid"
							style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #f2f4f3;">
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:#f2f4f3;">
								<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:#2485c1"><![endif]-->
								<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color:#2485c1;width:600px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 20px; padding-top:5px; padding-bottom:5px;"><![endif]-->
								<div class="col num12"
									style="min-width: 320px; max-width: 600px; display: table-cell; vertical-align: top; width: 600px;">
									<div style="width:100% !important;">
										<!--[if (!mso)&(!IE)]><!-->
										<div
											...
											<div align="left" class="img-container left fixedwidth"
												...
												<div style="font-size:1px;line-height:25px"> </div><img alt="Image" border="0"
													class="left fixedwidth" src="{!!url('https://res.cloudinary.com/sarjanamalam/image/upload/v1580354954/email/logo_1_yalzyd.png')!!}"
								...
								<div class="col num12"
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div
												style="color:#132F40;font-family:Lato, Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
												<div
													style="font-size: 12px; line-height: 1.2; color: #132F40; font-family: Lato, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
													<p
														style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;">
														<span style="font-size: 22px;">Hello <b>{{$data_member->name}}</b>, registration
															completed!</span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
												...
												<div
													...
													<p
														...
														<span style="font-size: 16px;">Thanks so much for joining our
															site! </span><br /><span style="font-size: 16px;">Your username is: <span
					...
					<div
						style="background-image:url('{!!url('https://res.cloudinary.com/sarjanamalam/image/upload/v1580354743/email/bg_password_nzrz8r.gif')!!}');background-position:top center;background-repeat:no-repeat;background-color:transparent;">
						<div class="block-grid no-stack"
							style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
								<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('{!!url('https://res.cloudinary.com/sarjanamalam/image/upload/v1580354743/email/bg_password_nzrz8r.gif')!!}');background-position:top center;background-repeat:no-repeat;background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
								...
								<div class="col num12"
								    ...
								    <div style="width:100% !important;">
								        ...
								        <div
								            ...
								            <div
								                style="color:#555555;font-family:Lato, Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
								                <div
								                    style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Lato, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
								                    <p
								                        style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin: 0;">
								                        <span style="font-size: 16px;">To finish signing up and <span
								                                style="color: #132f40; font-size: 16px;"><strong>activate your account
								                                </strong></span></span></p>
								                    <p
								                        style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin: 0;">
								            ...
								            <form action="http://localhost:8000/verification-user/{{$data_member->id}}/{{$tokens}}"
								                ...
								                <div align="left" class="button-container"
								                    ...
								                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 5px; padding-right: 10px; padding-bottom: 35px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:31.5pt; width:192pt; v-text-anchor:middle;" arcsize="120%" stroke="false" fillcolor="#2485c1"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#132F40; font-family:Arial, sans-serif; font-size:15px"><![endif]-->
								                    <div>
														...
														<span
															...
															<span
																...
																<span data-mce-style="font-size: 15px; line-height: 30px;"
																	style="font-size: 15px; line-height: 30px;"><strong>
																		<span data-mce-style="line-height: 30px; font-size: 15px;"
																			style="line-height: 30px; font-size: 15px;">ACTIVATE MY ACCOUNT
																			&gt;
																		</span>
																	</strong>
																</span>
												...
												<tbody>
													<tr style="vertical-align: top;" valign="top">
														<td style="word-break: break-word; vertical-align: top; padding-top: 20px; padding-right: 35px; padding-bottom: 10px; padding-left: 10px;"
															valign="top">
															<table align="right" cellpadding="0" cellspacing="0" class="social_table"
																role="presentation"
																...
																<tbody>
																	<tr align="right" style="vertical-align: top; display: inline-block; text-align: right;" valign="top">
																	    <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 0px; padding-left: 10px;"
																	        valign="top"><a href="https://www.facebook.com/sarjanamalamdotcom" target="_blank"><img
																	                alt="Facebook" height="32"
																	                src="https://res.cloudinary.com/sarjanamalam/image/upload/v1580355784/email/facebook2x_dhk1nv.png"
																	                style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
																	                title="Facebook" width="32" /></a>
																	    </td>
																	    <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 0px; padding-left: 10px;"
																	        valign="top"><a href="https://twitter.com/sarjanamalamcom" target="_blank"><img alt="Facebook"
																	                height="32"
																	                src="https://res.cloudinary.com/sarjanamalam/image/upload/v1580355785/email/instagram2x_pcfzkv.png"
																	                style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
																	                title="Facebook" width="32" /></a></td>
																	    <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 0px; padding-left: 10px;"
																	        valign="top"><a href="https://instagram.com/sarjanamalamdotcom" target="_blank"><img
																	                alt="Facebook" height="32"
																	                src="https://res.cloudinary.com/sarjanamalam/image/upload/v1580355784/email/twitter2x_jgdhuv.png"
																	                style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
																	                title="Facebook" width="32" /></a></td>
																	</tr>
																</tbody>
