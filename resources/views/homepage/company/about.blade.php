...
<head>
    ...
    <meta name="description"
        content="Di halaman tentang kami ini, biarkan kami bercerita tentang siapa kami dan apa yang kami lakukan.">
    <link rel="shortcut icon" href="{!!asset('storage/webicon.png')!!}" type="image/x-icon">
    <meta name="robots" content="index, follow">
    <meta name="language" content="English">
    <script src="https://kit.fontawesome.com/ae026c985d.js" crossorigin="anonymous"></script>

    <title>Tentang Sarjanamalam.</title>
                ...
                <div class="container">
                    ...
                    <div id="mainMenu">
                        <div class="container">
                            <nav>
                                <ul>
                                    <li><a href="/tentang-sarjana-malam" class="current">Tentang</a></li>
                                    <li><a href="/yang-kami-buat">Produk Kami</a></li>
                                    <li><a href="/yang-kami-buat">Cerita Kami</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="copyright-content">
            <div class="container">
                <div class="copyright-text text-center">&copy; 2019 POLO - Responsive Multi-Purpose HTML5 Template. All
                    Rights Reserved.<a href="//www.inspiro-media.com" target="_blank"> INSPIRO</a> </div>
            </div>
        </div>
    </footer>
