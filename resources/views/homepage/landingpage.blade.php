        ...
        <div class="inner">
          ...
          <a href="/forum/{{$tokens}}" class="nav-link">Forum</a>
            ...
            <div class="avatar pull-left dropdown">
              ...
              <li role="presentation"><a role="menuitem" href="#" tabindex="-1"><strong>{{Auth()->user()->name}}</strong></a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-2" href="#">Profil saya</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-3" href="#">Pesan</a></li>
              <li role="presentation"><a role="menuitem" tabindex="-4" href="/logout/{{auth()->user()->id}}{{$tokens}}">Keluar</a></li>
              </ul>
          </div>
          </nav>
        </div>
