...
<head>
    ...
    <script type="text/javascript" src="{!!asset('css/new/plugins/js/revolution.extension.video.min.js')!!}">
    </script>
        ...
        <section id="slider">
                ...
                <div id="rev_slider_152_1" class="rev_slider fullscreenbanner" style="display:none;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-414" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <img src="{!!asset('storage/img/comingsoon.jpg')!!}" alt="" data-bgposition="center center"
                            ...
                            {{-- <div class="tp-caption   tp-resizeme" data-x="['left','left','left','left']"
                                data-hoffset="['870','640','450','315']" data-y="['top','top','top','top']"
                                data-voffset="['450','380','380','220']" data-fontsize="['200','150','100','70']"
                                data-width="['300','300','200','100']" data-height="none" data-whitespace="nowrap"
                                data-type="text" data-basealign="slide" data-responsive_offset="on"
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]" data-blendmode="screen"
                                style="z-index: 11; min-width: 300px; max-width: 300px; white-space: nowrap; font-size: 200px; line-height: 200px; font-weight: 600; color: #2485c1;font-family:Poppins;letter-spacing:-5px;"
                                id="t_seconds">00 </div> --}}
                            ...
                            {{-- <div class="tp-caption   tp-resizeme" id="slide-414-layer-13"
            ...
            <script type="text/javascript">
                ...
                tpj(document).ready(function () {
                    ...
                    var targetdate = new Date().getTime() + '2020/02/20' // i.e. '2015/12/31 24:00',
                    slidechanges = [{
                            days: 60,
                            hours: 0,
                            minutes: 0,
